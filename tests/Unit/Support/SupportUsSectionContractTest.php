...
final class SupportUsSectionContractTest extends TestCase {
	...
	public function testCssContractHasFocusAndReducedMotion(): void {
		...
		if (is_file($dedicated)) {
			...
			self::assertStringContainsString('#app-content.projectcheck-app--admin-support-us ul.projectcheck-support-us-page__trust', $pageCss);
			...
			self::assertMatchesRegularExpression(
				'/\.projectcheck-support-us--page \.projectcheck-support-us__primary\s*\{[^}]*max-width:\s*none/s',
				$pageCss,
