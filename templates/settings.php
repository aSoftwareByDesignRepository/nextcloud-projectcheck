		...
		<div class="settings-container">
			...
			<form id="settings-form" class="settings-form">
				...
				<div class="settings-section">
					...
					<div class="form-group">
						<label for="dateFormat"><?php p($l->t('Date Format')); ?></label>
						<select id="dateFormat" name="dateFormat" class="form-control">
							<option value="Y-m-d" <?php if ($settings['dateFormat'] === 'Y-m-d') p('selected'); ?>>
								<?php p($l->t('YYYY-MM-DD')); ?>
							</option>
							<option value="d/m/Y" <?php if ($settings['dateFormat'] === 'd/m/Y') p('selected'); ?>>
								<?php p($l->t('DD/MM/YYYY')); ?>
							</option>
							<option value="m/d/Y" <?php if ($settings['dateFormat'] === 'm/d/Y') p('selected'); ?>>
								<?php p($l->t('MM/DD/YYYY')); ?>
							</option>
						</select>
					</div>
				</div>
